...
**Files:**
- Modify: `PROJECT_ROOT/music/ncm_to_mp3.py`
- Modify: `PROJECT_ROOT/music/tests_ncm_to_mp3.py`
...
**Files:**
- Create: `PROJECT_ROOT/music/tests_ncm_gui.py`
...
### Task 3: 瀹炵幇 PySide6 涓荤晫闈?
**Objective:** 瀹屾垚鎷栨嫿鍖恒€佹枃浠跺垪琛ㄣ€佽緭鍑虹洰褰曢€夋嫨銆佸紑濮嬭浆鎹€佽繘搴︿笌鏃ュ織銆?

**Files:**
- Create: `PROJECT_ROOT/music/ncm_gui.py`
- Modify: `PROJECT_ROOT/music/tests_ncm_gui.py`
...
**Files:**
- Modify: `PROJECT_ROOT/music/progress.md`
- Modify: `PROJECT_ROOT/music/findings.md`
