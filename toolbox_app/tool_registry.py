...
TOOL_DEFINITIONS: list[ToolDef] = [
    ...
    ToolDef('directdownloader', '直链下载', '直链下载', 'modules/direct-downloader', 'converter.py', 'tab.py'),
...
_CONVERTER_KEYS_BY_TOOL_ID = {
    ...
    'directdownloader': ('directdownloader', 'direct_downloader'),
...
_TAB_KEYS_BY_TOOL_ID = {
    ...
    'directdownloader': ('directdownloader_tab', 'direct_downloader_tab'),
